...
export APP_ENV=prod
export APP_DATABASE_NAME=${ARTIFAKT_MYSQL_DATABASE_NAME:pocsylius_test_sylius}
export APP_DATABASE_USER=${ARTIFAKT_MYSQL_USER:pocsylius}
export APP_DATABASE_PASSWORD=${ARTIFAKT_MYSQL_PASSWORD:KbejuzKVKLSW5rQc9Us9}

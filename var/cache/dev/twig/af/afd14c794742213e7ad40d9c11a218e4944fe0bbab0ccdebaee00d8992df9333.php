...
class __TwigTemplate_cbd2fa39b43eef36e36f819b17a98d9b755e0943594e9452da10f5f8e2b00d8f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<h1 class=\"ui header\">
    ...
    <div class=\"content\">
        ...
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('sylius_locale_name')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["sylius"]) || array_key_exists("sylius", $context) ? $context["sylius"] : (function () { throw new RuntimeError('Variable "sylius" does not exist.', 13, $this->source); })()), "localeCode", [], "any", false, false, false, 13)]), "html", null, true);
        echo "
                </div>
            </div>
        </div>
...
", "@SyliusShop/Checkout/Complete/_header.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Checkout/Complete/_header.html.twig");
    }
}

...
class __TwigTemplate_f9e50f676507fc2e317b08dbbe53e204b7303ffc90ef9be40b1e90615acb2b76 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui two column centered stackable grid\">
        ...
        echo "
                ";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 22, $this->source); })()), "email", [], "any", false, false, false, 22), 'row', call_user_func_array($this->env->getFunction('sylius_test_form_attribute')->getCallable(), ["contact-email"]));
        echo "
                ";
        // line 23
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 23, $this->source); })()), "message", [], "any", false, false, false, 23), 'row', call_user_func_array($this->env->getFunction('sylius_test_form_attribute')->getCallable(), ["contact-message"]));
        echo "
...
{% endblock %}
", "@SyliusShop/Contact/request.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Contact/request.html.twig");
    }
}

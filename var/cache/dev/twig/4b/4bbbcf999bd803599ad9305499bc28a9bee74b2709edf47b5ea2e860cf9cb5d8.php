...
class __TwigTemplate_c6572996b93c1cc04e089fea5e91749fece4a0ca0d660441406ad2d6a70317ec extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"attributes\">
    ...
    <div class=\"ui attached segment\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["attributeValue"]) {
            ...
            if (!twig_in_filter(twig_get_attribute($this->env, $this->source, $context["attributeValue"], "localeCode", [], "any", false, false, false, 9), (isset($context["setLocales"]) || array_key_exists("setLocales", $context) ? $context["setLocales"] : (function () { throw new RuntimeError('Variable "setLocales" does not exist.', 9, $this->source); })()))) {
                ...
                if ( !(null === twig_get_attribute($this->env, $this->source, $context["attributeValue"], "localeCode", [], "any", false, false, false, 11))) {
                    ...
                    echo " data-tab=\"";
                    echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('sylius_locale_name')->getCallable(), [(isset($context["localeCode"]) || array_key_exists("localeCode", $context) ? $context["localeCode"] : (function () { throw new RuntimeError('Variable "localeCode" does not exist.', 12, $this->source); })())]), "html", null, true);
                    echo "\" ";
                    echo call_user_func_array($this->env->getFunction('sylius_test_html_attribute')->getCallable(), ["tab", call_user_func_array($this->env->getFilter('sylius_locale_name')->getCallable(), [(isset($context["localeCode"]) || array_key_exists("localeCode", $context) ? $context["localeCode"] : (function () { throw new RuntimeError('Variable "localeCode" does not exist.', 12, $this->source); })())])]);
                    echo ">";
                    ...
                    echo "\" ";
                    echo call_user_func_array($this->env->getFunction('sylius_test_html_attribute')->getCallable(), ["tab", "non-translatable"]);
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["locale"]) {
            // line 21
            echo "            ";
            $context["data_tab"] = (( !(null === $context["locale"])) ? (call_user_func_array($this->env->getFilter('sylius_locale_name')->getCallable(), [$context["locale"]])) : ("non-translatable"));
            // line 22
            ...
            echo "\" ";
            echo call_user_func_array($this->env->getFunction('sylius_test_html_attribute')->getCallable(), ["tab", (isset($context["data_tab"]) || array_key_exists("data_tab", $context) ? $context["data_tab"] : (function () { throw new RuntimeError('Variable "data_tab" does not exist.', 22, $this->source); })())]);
            echo ">
...
", "@SyliusAdmin/Product/Show/_attributes.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/Show/_attributes.html.twig");
    }
}

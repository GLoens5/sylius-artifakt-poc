...
class __TwigTemplate_4f9f441b7cbdf03594f1dd68e425b23acbe53207d659f38ed76eec4a3c3a6967 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["optionValue"]) {
                ...
                echo "\" ";
                echo call_user_func_array($this->env->getFunction('sylius_test_html_attribute')->getCallable(), ["option-name", twig_get_attribute($this->env, $this->source, $context["optionValue"], "name", [], "any", false, false, false, 21)]);
                echo ">
                ";
                // line 22
...
{% endif %}
", "@SyliusShop/Product/_info.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Product/_info.html.twig");
    }
}

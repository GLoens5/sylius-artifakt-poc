...
class __TwigTemplate_5f5b18fa126e34bf5f4148216e127d48b3ec182ffcb157936cca1c1b370c06f2 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <div class=\"column\">
            ...
            echo "\" data-currency=\"";
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('sylius_currency_symbol')->getCallable(), [(isset($context["currency"]) || array_key_exists("currency", $context) ? $context["currency"] : (function () { throw new RuntimeError('Variable "currency" does not exist.', 9, $this->source); })())]), "html", null, true);
            echo "\"></canvas>
            </div>
        </div>
    </div>
...
{% endif %}
", "@SyliusAdmin/Dashboard/_chart.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Dashboard/_chart.html.twig");
    }
}

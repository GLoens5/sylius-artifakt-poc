...
class __TwigTemplate_3bef6fc7199948b9f850c4097ed27278fac6be3a61f5329cf0e2ae96e5bf32b4 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"ui three column centered stackable grid\">
        ...
        echo "
                ";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 22, $this->source); })()), "email", [], "any", false, false, false, 22), 'row', call_user_func_array($this->env->getFunction('sylius_test_form_attribute')->getCallable(), ["reset-email"]));
        echo "
...
{% endblock %}
", "@SyliusShop/Account/requestPasswordReset.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/requestPasswordReset.html.twig");
    }
}

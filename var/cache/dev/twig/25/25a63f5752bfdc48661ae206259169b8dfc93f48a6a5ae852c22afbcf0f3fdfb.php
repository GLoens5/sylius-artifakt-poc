...
class __TwigTemplate_c08258cea83083b5e34892759eeadababc87c84f1f3fc6ce20853be54ca0a39b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<h1 class=\"ui header\">
    ...
    <div class=\"content\">
        ...
        echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('sylius_locale_name')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 20, $this->source); })()), "localeCode", [], "any", false, false, false, 20)]), "html", null, true);
        echo "
                </div>
            </div>
        </div>
...
{% endif %}
", "@SyliusShop/Account/Order/Show/_header.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/ShopBundle/Resources/views/Account/Order/Show/_header.html.twig");
    }
}

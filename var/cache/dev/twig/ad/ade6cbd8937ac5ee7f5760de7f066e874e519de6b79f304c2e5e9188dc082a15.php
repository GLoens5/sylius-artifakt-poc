...
class __TwigTemplate_4b2352cf6c30e8271add48f4fb38e7442aabfe2dd78df4c667300c9a0bdb30a5 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"column\">
        ...
        if (((isset($context["labels"]) || array_key_exists("labels", $context) ? $context["labels"] : (function () { throw new RuntimeError('Variable "labels" does not exist.', 75, $this->source); })()) && (isset($context["values"]) || array_key_exists("values", $context) ? $context["values"] : (function () { throw new RuntimeError('Variable "values" does not exist.', 75, $this->source); })()))) {
            ...
            echo "\"
                        data-currency=\"";
            // line 87
            echo twig_escape_filter($this->env, call_user_func_array($this->env->getFilter('sylius_currency_symbol')->getCallable(), [twig_get_attribute($this->env, $this->source, (isset($context["channel"]) || array_key_exists("channel", $context) ? $context["channel"] : (function () { throw new RuntimeError('Variable "channel" does not exist.', 87, $this->source); })()), "base_currency_code", [], "any", false, false, false, 87)]), "html", null, true);
            echo "\">
                    </canvas>
...
", "@SyliusAdmin/Dashboard/Statistics/_template.html.twig", "/home/gloens/workspace/php/veille/Sylius/project/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Dashboard/Statistics/_template.html.twig");
    }
}

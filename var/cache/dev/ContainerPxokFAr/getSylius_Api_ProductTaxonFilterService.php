 ...
 */
class getSylius_Api_ProductTaxonFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'sylius.api.product_taxon_filter' shared service.
     *
     * @return \Sylius\Bundle\ApiBundle\Filter\TaxonFilter
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/sylius/sylius/src/Sylius/Bundle/ApiBundle/Filter/TaxonFilter.php';

        return $container->privates['sylius.api.product_taxon_filter'] = new \Sylius\Bundle\ApiBundle\Filter\TaxonFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->privates['api_platform.iri_converter'] ?? $container->getApiPlatform_IriConverterService()));
    }
}

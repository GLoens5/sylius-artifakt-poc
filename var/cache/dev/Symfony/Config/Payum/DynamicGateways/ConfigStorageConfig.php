...
class ConfigStorageConfig 
{
    ...
    public function doctrine(array $value = []): \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\DoctrineConfig
    {
    ...
    public function custom(array $value = []): \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\CustomConfig
    {
        if (null === $this->custom) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (isset($value['doctrine'])) {
            $this->doctrine = new \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\DoctrineConfig($value['doctrine']);
            unset($value['doctrine']);
        }
    
        if (isset($value['custom'])) {
            $this->custom = new \Symfony\Config\Payum\DynamicGateways\ConfigStorageConfig\CustomConfig($value['custom']);
            unset($value['custom']);
        }
